...
export function useTimeline() {
   ...
   */
  const fetchEntries = useCallback(async (filters: TimelineFilters, viewOptions: TimelineViewOptions) => {
      ...
      const mockEntries: TimelineEntryUnion[] = [
        {
          ...
          description: 'A contemplative piece exploring themes of solitude and growth',
        ...
        },
        {
          ...
          description: 'An inside look at how this track came together over several late-night studio sessions',
...
This track started as a simple piano melody that came to me during a particularly quiet evening...`,
          excerpt: 'This track started as a simple piano melody that came to me during a particularly quiet evening.',
          readTimeMinutes: 3,
        ...
        },
        {
          ...
          description: 'Digital artwork exploring the flow of sound waves and emotion',
          ...
          imageAlt: 'Flowing blue and purple waves with musical notation elements',
          medium: 'Digital Art',
      ...
      setState(prev => ({
        ...prev,
        loading: false,
        error: error instanceof Error ? error.message : 'Failed to load timeline entries',
      }))
    }
   ...
   */
  const updateViewOptions = useCallback((newViewOptions: Partial<TimelineViewOptions>) => {
